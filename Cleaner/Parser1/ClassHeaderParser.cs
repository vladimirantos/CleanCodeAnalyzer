...
namespace Cleaner.Parser1
{
    class ClassHeaderParser : BaseParser
    {
        ...
        public ClassHeaderParser(ClassDeclarationSyntax classDeclarationSyntax)
        {
        ...
        public override void Parse()
        {
            ...
            Result = new ClassHeader(accessModifier, _syntax.Identifier.ToString(), classModifiersList, GetInheritingClasses());
        }
        ...
        private List<string> GetInheritingClasses()
        {
            ...
            List<string> tokens = _syntax.DescendantTokens().Select(x => x.ToString()).ToList();
